import {
  ...
  P as PAGE_METHODS,
  s as negotiate,
  r as method_not_allowed,
  n as handle_error_and_jsonify,
  m as get_status,
  q as is_form_content_type,
  u as normalize_error,
  d as create_replacer,
  t as noop,
  j as get_global_name,
  z as serialize_uses,
  c as clarify_devalue_error,
  k as get_node_type,
  g as escape_html,
  b as create_remote_key,
  x as parse_remote_arg,
  f as deserialize_binary_form,
  D as stringify,
  B as split_remote_key,
  S as SVELTE_KIT_ASSETS,
  C as static_error_page,
  y as redirect_response,
  w as once,
  p as has_prerendered_path,
  l as get_set_cookies,
...
import {
  ...
  w as writable,
  r as readable,
  e as validate_layout_server_exports,
  v as validate_layout_exports,
  g as validate_page_server_exports,
  f as validate_page_exports,
  n as normalize_path,
  c as resolve,
...
${indent}}`);
    ...
    const serialized_data =
      Object.keys(remote_data).length > 0
        ? `${global}.data = ${devalue.uneval(remote_data, create_replacer(options2.hooks.transport))};
    ...
    try {
      ...
      if (route) {
        ...
        if (is_data_request) {
          ...
          route.endpoint &&
          (!route.page || (!state.prerendering && is_endpoint_request(event2)))
        ) {
